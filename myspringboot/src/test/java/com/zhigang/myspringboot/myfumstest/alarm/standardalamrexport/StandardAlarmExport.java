...
public class StandardAlarmExport {
    ...
    public static void exportAlarms() {
        ...
        try {
            ...
            conn = DriverManager.getConnection(StandardAlarmExport.DB_URL, StandardAlarmExport.USERNAME, StandardAlarmExport.PWD);
            // 执行查询
            ...
            String fileName = StandardAlarmExport.FILE_NAME + "_" + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) + StandardAlarmExport.SUFFIX;
