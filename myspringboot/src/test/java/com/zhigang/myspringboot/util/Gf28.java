...
public class Gf28 {
     ...
     * 逆S盒
     */
    private static final int[] sBox2 = {0x52, 0x09, 0x6a, 0xd5, 0x30, 0x36, 0xa5, 0x38, 0xbf, 0x40, 0xa3, 0x9e, 0x81, 0xf3, 0xd7, 0xfb,
    ...
    private static void creatGf28() {
        ...
        System.out.println("根据正反表得到S盒中间表：");
        for (int i = 0; i < 256; i++) {
        ...
        System.out.println("S盒做仿射变换得到S盒：");
        for (int i = 0; i < 256; i++) {
