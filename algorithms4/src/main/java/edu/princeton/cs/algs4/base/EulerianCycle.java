...
import edu.princeton.cs.algs4.map.BreadthFirstPaths;
import edu.princeton.cs.algs4.map.DirectedEulerianCycle;
import edu.princeton.cs.algs4.map.DirectedEulerianPath;
import edu.princeton.cs.algs4.map.EulerianPath;
