...
public final class StdIn {
    ...
    public static String readString() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'String' value from standard input, " + "but no " +
    ...
    public static int readInt() {
        try {
            ...
            String token = StdIn.scanner.next();
    ...
    public static double readDouble() {
        try {
            ...
            throw new NoSuchElementException("attempts to read a 'double' value from standard input, " + "but no " +
                    "more" + " tokens are available");
        }
    }
    ...
    public static float readFloat() {
        try {
            ...
            String token = StdIn.scanner.next();
            throw new InputMismatchException("attempts to read a 'float' value from standard input, " + "but the " +
                    "next" + " token is \"" + token + "\"");
        } catch (NoSuchElementException e) {
            throw new NoSuchElementException("attempts to read a 'float' value from standard input, " + "but there " +
    ...
    public static short readShort() {
        try {
            ...
            String token = StdIn.scanner.next();
            throw new InputMismatchException("attempts to read a 'short' value from standard input, " + "but the " +
                    "next" + " token is \"" + token + "\"");
        } catch (NoSuchElementException e) {
